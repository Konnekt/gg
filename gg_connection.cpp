...
//                           IMLOG("____HOST %s:%d %x" , string(longToIp(n->remote_ip)).c_str() , n->remote_port , n->remote_ip);
                  ...
                  case GG_EVENT_STATUS: {
                       ...
                       switch (e->event.status.status) {
                           case GG_STATUS_NOT_AVAIL_DESCR: descr=e->event.status.descr ;break;
                           case GG_STATUS_AVAIL_DESCR: descr=e->event.status.descr ;
                              case GG_STATUS_AVAIL: b=ST_ONLINE; break;
                           case GG_STATUS_BUSY_DESCR: descr=e->event.status.descr;
                              case GG_STATUS_BUSY: b=ST_AWAY; break;
                           case GG_STATUS_BLOCKED: b=ST_BLOCKING; break;
...
//                           IMLOG("____HOST %s:%d %x" , string(longToIp(n->remote_ip)).c_str() , n->remote_port , n->remote_ip);
				  ...
				  case GG_EVENT_STATUS60: {
                       ...
                       switch (e->event.status60.status) {
                           case GG_STATUS_NOT_AVAIL_DESCR: descr=e->event.status60.descr ;break;
                           case GG_STATUS_AVAIL_DESCR: descr=e->event.status60.descr ;
                              case GG_STATUS_AVAIL: b=ST_ONLINE; break;
                           case GG_STATUS_BUSY_DESCR: descr=e->event.status60.descr;
                              case GG_STATUS_BUSY: b=ST_AWAY; break;
                           case GG_STATUS_BLOCKED: b=ST_BLOCKING; break;
